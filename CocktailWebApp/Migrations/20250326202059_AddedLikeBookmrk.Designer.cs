...
namespace CocktailWebApp.Migrations
{
    ...
    [Migration("20250326202059_AddedLikeBookmrk")]
    partial class AddedLikeBookmrk
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CocktailWebApp.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("CocktailWebApp.Models.Bookmark", b =>
                {
            ...
            modelBuilder.Entity("CocktailWebApp.Models.Like", b =>
                {
                    b.Property<string>("AppUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CocktailWebApp.Models.Bookmark", b =>
                {
                    b.HasOne("CocktailWebApp.Models.AppUser", "BookmarkedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("CocktailWebApp.Models.Cocktail", b =>
                {
                    b.HasOne("CocktailWebApp.Models.AppUser", "Creator")
            ...
            modelBuilder.Entity("CocktailWebApp.Models.Like", b =>
                {
                    b.HasOne("CocktailWebApp.Models.AppUser", "LikedByUser")
                        .WithMany()
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CocktailWebApp.Models.AppUser", null)
                        .WithMany()
